...
## Social Proof
**4.8 stars / 262 reviews** — use this exact figure consistently everywhere.
...
| Service | Price |
|---------|-------|
| Dispatch fee | $99 (all calls, including PMA members on repair visits) |
| Diagnostic | $111 (credited toward repair if approved within 14 days) |
| Tune-up | $229 flat |
| Emergency call | $99 dispatch + $111 diagnostic + repair |
...
### Financing
Synchrony, Wells Fargo, Wisetack

---

## Service Area
| County | Key Cities | Utility / Rebate Hook |
|--------|-----------|----------------------|
| Kingfisher (home base) | Kingfisher, Okarche, Hennessey | KPWA + Cimarron Electric |
| Canadian | Yukon, Mustang, El Reno, Tuttle | CKenergy $2,000/ton geo |
| Garfield | Enid | OG&E $1,000/ton geo |
| Logan | Guthrie, Crescent, Langston | OEC + CREC rebates |
| Major | Fairview, Ringwood | No major utility rebate |
| Oklahoma | NW OKC metro, Edmond | OG&E + Edmond Electric |
| Blaine | Watonga, Longdale | CKenergy $2,000/ton geo |

---

## Services

**Residential:** AC repair/install, heating repair/install, heat pump repair/install, ductless mini-split (Mitsubishi Diamond), geothermal install/repair/maintenance, water heater replacement/repair, indoor air quality, zoning, HVAC tune-up & maintenance plans, new construction, manual J load calculations

**Commercial/Specialty:** Rooftop units, commercial refrigeration, boilers, cooling towers, industrial HVAC, oil field HVAC, cannabis cultivation HVAC, controlled environment, sheet metal/ductwork, generator services, HVAC + light plumbing

**Emergency:** 24/7 emergency HVAC (Kingfisher, OKC, statewide)
...
## Brand Voice
- First person as Dave: "I've been doing X in Kingfisher since..."
- Plain-spoken, expert, no hype
